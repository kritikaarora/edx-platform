 ...
 */
define(['jquery', 'backbone', 'underscore', 'gettext', 'js/views/baseview', 'js/views/modals/base_modal', 'date',
    'js/views/utils/xblock_utils', 'js/utils/date_utils', 'edx-ui-toolkit/js/utils/html-utils',
    'edx-ui-toolkit/js/utils/string-utils', 'js/views/modals/course_outline_modals/settings_xblock_modal',
    'js/views/modals/course_outline_modals/publish_xblock_modal',
    'js/views/modals/course_outline_modals/highlights_xblock_modal',
    'js/views/modals/course_outline_modals/highlights_enable_xblock_modal',
], function(
    $, Backbone, _, gettext, BaseView, BaseModal, date, XBlockViewUtils, DateUtils, HtmlUtils, StringUtils,
    SettingsXBlockModal, PublishXBlockModal, HighlightsXBlockModal, HighlightsEnableXBlockModal
) {
    'use strict';
    var AbstractEditor, BaseDateEditor, ReleaseDateEditor, DueDateEditor, GradingEditor, PublishEditor,
        AbstractVisibilityEditor, StaffLockEditor, UnitAccessEditor, ContentVisibilityEditor,
        TimedExaminationPreferenceEditor, AccessEditor, ShowCorrectnessEditor, HighlightsEditor, HighlightsEnableEditor;
